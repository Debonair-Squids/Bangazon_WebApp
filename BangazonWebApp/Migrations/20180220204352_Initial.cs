    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductLikeDislike", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductLikeDislike_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRecommend", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductRecommend_AspNetUsers_RecommendeeId",
                        column: x => x.RecommendeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductRecommend_AspNetUsers_RecommenderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Invoice_UserPayment_UserPaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductLikeDislike_UserId",
                table: "ProductLikeDislike",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRecommend_RecommendeeId",
                table: "ProductRecommend",
                column: "RecommendeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRecommend_RecommenderId",
                table: "ProductRecommend",
